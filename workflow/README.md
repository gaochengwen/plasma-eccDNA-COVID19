...
| `protected_run.py` | Runs a figure generator as a subprocess with the output tree fingerprinted before and after, restoring anything the generator overwrote. Several generators end by copying results to hard-coded absolute paths that later renumbering made wrong. |
